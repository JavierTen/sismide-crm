...
class RutasEmprendimiento extends Page
{
    ...
    {
        return [
            'ruta1' => $this->getRouteData(0, 50, 'Ruta 1: Pre-emprendimiento y validación temprana'),
            'ruta2' => $this->getRouteData(51, 85, 'Ruta 2: Consolidación'),
            'ruta3' => $this->getRouteData(86, 100, 'Ruta 3: Escalamiento'),
        ];
    }
