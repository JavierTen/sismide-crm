...
class EconomicActivityResource extends Resource
{
    ...
    private static function userCanList(): bool
    {
        ...
        return $user->can('listEconomicActivitys');
    }
    ...
    private static function userCanCreate(): bool
    {
        ...
        return $user->can('createEconomicActivity');
    }
    ...
    private static function userCanEdit(): bool
    {
        ...
        return $user->can('editEconomicActivity');
    }
    ...
    private static function userCanDelete(): bool
    {
        ...
        return $user->can('deleteEconomicActivity');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Información de la actividad económica')
                    ->description('Configuración básica de la actividad económica')
                    ->icon('heroicon-o-document-text')
                    ->schema([
                        Forms\Components\Grid::make(1)
                            ->schema([
                                Forms\Components\TextInput::make('name')
                                    ->label('Nombre de la Actividad Económica')
                                    ->required()
                                    ->maxLength(100)
                                    ->placeholder('Ej: Sector primario, Sector secundario')
                                    ->helperText('Nombre completo de la actividad económica'),
                            ]),
                    ])
                    ->collapsible()
                    ->persistCollapsed(),
                ...
                Forms\Components\Section::make('Configuración')
                    ...
                    ->schema([
                        Forms\Components\Toggle::make('status')
                            ->label('Estado Activo')
                            ->helperText('Determina si esta actividad económica está disponible para uso')
                            ->default(true)
                            ->inline(false)
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\EditAction::make()
                    ...
                    ->tooltip('Editar actividad económica')
                ...
                Tables\Actions\RestoreAction::make()
                    ...
                    ->color('success')
                    ->tooltip('Restaurar actividad económica')
                    ->visible(fn($record) => $record->trashed() && static::userCanDelete()),
