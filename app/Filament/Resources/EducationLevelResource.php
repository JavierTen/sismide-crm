...
class EducationLevelResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Nivel de Educación';
    protected static ?string $pluralModelLabel = 'Niveles de Educación';
    ...
    private static function userCanList(): bool
    {
        ...
        return $user->can('listEducationLevels');
    }
    ...
    private static function userCanCreate(): bool
    {
        ...
        return $user->can('createEducationLevel');
    }
    ...
    private static function userCanEdit(): bool
    {
        ...
        return $user->can('editEducationLevel');
    }
    ...
    private static function userCanDelete(): bool
    {
        ...
        return $user->can('deleteEducationLevel');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Información del nivel de educación')
                    ->description('Configuración básica del nivel de educación')
                    ->icon('heroicon-o-document-text')
                    ->schema([
                        Forms\Components\Grid::make(1)
                            ->schema([
                                Forms\Components\TextInput::make('name')
                                    ->label('Nombre del Nivel de Educación')
                                    ->required()
                                    ->maxLength(100)
                                    ->placeholder('Ej: Primaria, Secundaria')
                                    ->helperText('Nombre completo del nivel de educación'),
                            ]),
                    ])
                    ->collapsible()
                    ->persistCollapsed(),
                ...
                Forms\Components\Section::make('Configuración')
                    ...
                    ->schema([
                        Forms\Components\Toggle::make('status')
                            ->label('Estado Activo')
                            ->helperText('Determina si este nivel de educación está disponible para uso')
                            ->default(true)
                            ->inline(false)
