...
class GenderResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Información del género')
                    ->description('Configuración básica del género')
                        ...
                        Forms\Components\Grid::make(1)
                            ->schema([
                                Forms\Components\TextInput::make('name')
                                    ...
                                    ->helperText('Nombre completo del género'),
                            ]),
                    ])
                    ->collapsible()
                    ->persistCollapsed(),
                ...
                Forms\Components\Section::make('Configuración')
                    ...
                    ->schema([
                        Forms\Components\Toggle::make('status')
                            ->label('Estado Activo')
                            ->helperText('Determina si este género está disponible para uso')
                            ->default(true)
                            ->inline(false)
