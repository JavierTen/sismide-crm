...
class MaritalStatusResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Estados Civiles';
    ...
    private static function userCanList(): bool
    {
        ...
        return $user->can('listMaritalStatuses');
    }
    ...
    private static function userCanCreate(): bool
    {
        ...
        return $user->can('createMaritalStatus');
    }
    ...
    private static function userCanEdit(): bool
    {
        ...
        return $user->can('editMaritalStatus');
    }
    ...
    private static function userCanDelete(): bool
    {
        ...
        return $user->can('deleteMaritalStatus');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Información estado civil')
                    ->description('Configuración básica del estado civil')
                        ...
                        Forms\Components\Grid::make(1)
                            ->schema([
                                Forms\Components\TextInput::make('name')
                                    ...
                                    ->helperText('Nombre completo del estado civil'),
                            ]),
                    ])
                    ->collapsible()
                    ->persistCollapsed(),
                ...
                Forms\Components\Section::make('Configuración')
                    ...
                    ->schema([
                        Forms\Components\Toggle::make('status')
                            ->label('Estado Activo')
                            ->helperText('Determina si este estado civil está disponible para uso')
                            ->default(true)
                            ->inline(false)
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\RestoreAction::make()
                    ...
                    ->color('success')
                    ->tooltip('Restaurar estado civil')
                    ->visible(fn($record) => $record->trashed() && static::userCanDelete()),
