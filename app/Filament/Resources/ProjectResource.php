                        ...
                        Forms\Components\Grid::make(2)
                            ->schema([
                                Forms\Components\TextInput::make('acronym')
                                    ...
                                    ->required()
                                    ->maxLength(100)
                                    ->placeholder('Ej: C. MINERO')
                                    ->helperText('Sigla del proyecto'),
