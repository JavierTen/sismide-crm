...
class MaturityLevel4Widget extends ChartWidget
{
    protected static ?string $heading = 'Nivel 4: Consolidación avanzada (71-85 pts)';
    ...
    {
        $data = $this->getMunicipalityData(71, 85);
