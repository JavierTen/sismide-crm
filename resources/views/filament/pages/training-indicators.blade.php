...
<x-filament-panels::page>
    ...
    {{-- Cards de Emprendedores Únicos por Ruta --}}
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        @php
            $entrepreneursByRoute = $this->getUniqueEntrepreneursByRoute();
        @endphp
