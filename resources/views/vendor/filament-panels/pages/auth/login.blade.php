    ...
    @php
        ...
        $allPanels = [
            'dashboard' => [
                ...
                'description' => 'Para administradores y gestores',
                'route' => 'filament.dashboard.auth.login',
                'icon' => 'shield',
            ],
            'emprendedor' => [
                'label' => 'Portal del Emprendedor',
                'description' => 'Para emprendedores',
                'route' => 'filament.emprendedor.auth.login',
                'icon' => 'user',
            ],
            'eje' => [
                'label' => 'Proyecto Eje',
                'description' => 'Instituciones, docentes y estudiantes',
                'route' => 'filament.eje.auth.login',
                'icon' => 'building',
            ],
        ];

        $alternatePanels = collect($allPanels)->except($currentPanelId);
    @endphp

    @if ($alternatePanels->isNotEmpty())
        <div class="mt-6">
            <div class="relative">
            ...
            <div class="mt-6 space-y-3">
                @foreach ($alternatePanels as $panelInfo)
                    <a
                        href="{{ route($panelInfo['route']) }}"
